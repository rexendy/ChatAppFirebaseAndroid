 ...
 */
public class ChatListAsyncTask extends AsyncTask<Void, Void, JSONObject> {

    private String mApiUrl;
    private AsyncTaskContract mListener;

    private static final String TAG = "ChatListAsyncTask";

    public ChatListAsyncTask(String apiUrl) {
